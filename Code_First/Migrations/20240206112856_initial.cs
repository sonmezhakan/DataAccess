        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Fax = table.Column<string>(type: "char(11)", maxLength: 11, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Freigt = table.Column<decimal>(type: "money", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Sebze", null });

            migrationBuilder.InsertData(
                table: "Suppliers",
                columns: new[] { "SupplierId", "Address", "City", "CompanyName", "ContactName", "ContactTitle", "Country", "Fax", "PhoneNumber", "PostalCode", "Region" },
                values: new object[] { 1, "Küçük Yalı Mahallesi", "İstanbul", "A Manav", "Osman Yılmaz", "Deneme", "Türkiye", "05555555555", "05555555555", "340000", "Beykoz" });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductId", "CategoryId", "ProductName", "QuantityPerUnit", "SupplierId", "UnitPrice", "UnitsInStock" },
                values: new object[] { 1, 1, "Elma", "1kg 1 poşet", 1, 20m, (short)100 });
